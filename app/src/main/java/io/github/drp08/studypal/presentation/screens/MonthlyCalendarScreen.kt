...
object MonthlyCalendarScreen : Screen {
    ...
    override fun Content() {
            ...
            Column(
                ...
                CalendarHeader(
                    ...
                    onPreviousMonth = { currentMonth.value = currentMonth.value.minus(1, DateTimeUnit.MONTH) },
                    onNextMonth = { currentMonth.value = currentMonth.value.plus(1, DateTimeUnit.MONTH) }
                )
    ...
    @Composable
    fun CalendarHeader(currentMonth: LocalDate, onPreviousMonth: () -> Unit, onNextMonth: () -> Unit) {
        Row(
            modifier = Modifier
                .fillMaxWidth()
                .padding(8.dp),
