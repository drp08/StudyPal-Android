...
class WeeklyViewModel : ViewModel() {
    ...
    init {
        ...
        activities[DayOfWeek.MONDAY] = listOf(
            SessionEntity(1, "Meeting", 32400, 36000, 1), // 9:00 - 10:00
            SessionEntity(2, "Gym", 64800, 68400, 1)      // 18:00 - 19:00
        )
        activities[DayOfWeek.TUESDAY] = listOf(
            SessionEntity(3, "Lunch", 43200, 46800, 1),   // 12:00 - 13:00
            SessionEntity(4, "Study group", 50400, 57600, 1) // 14:00 - 16:00
        )
        activities[DayOfWeek.WEDNESDAY] = listOf(
            SessionEntity(5, "Appointment", 36000, 39600, 1) // 10:00 - 11:00
        )
        activities[DayOfWeek.THURSDAY] = listOf(
            SessionEntity(6, "Conference", 32400, 39600, 1)  // 9:00 - 11:00
        )
        activities[DayOfWeek.FRIDAY] = listOf(
            SessionEntity(7, "Presentation", 46800, 50400, 1) // 13:00 - 14:00
        )
    }
